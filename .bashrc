...
[[ $- != *i* ]] && return
#Attach to existing detached session or start a new session
...
alias apt-clean='sudo apt-get -y autoremove && sudo apt-get -y autoclean && sudo apt-get -y clean'
alias apt-update='sudo apt update && sudo apt upgrade -y'
alias pactl-unload='pactl unload-module module-bluetooth-discover'
alias pactl-load='pactl load-module module-bluetooth-discover'
alias calc='gnome-calculator'
alias cclip='xclip -i -f -selection primary | xclip -i -selection clipboard'
alias ssh-switch-wifi='sudo DISPLAY=:0 nmcli dev disconnect wlp2s0 ; sleep 60 && nmcli con up Wi-Fi\ Redmi\ 4\ 3/32'
alias d0='DISPLAY=:0'
# alias d0vlc='DISPLAY=:0 vlc --browse-dir $HOME/Videos'
